Instance: encounter-opd-ssop
InstanceOf: $SD_Encounter_Opd
Title: "ตัวอย่าง Encounter: SSOP"
Description: "การรับบริการ OPD โดยใช้ข้อมูลจากชุดข้อมูล SSOP"
Usage: #example
* meta.source = "ssop"
* extension[0]
...
* diagnosis
  * condition = Reference(Condition/condition-ssop)
...
* serviceProvider = Reference(Organization/organization-ssop)