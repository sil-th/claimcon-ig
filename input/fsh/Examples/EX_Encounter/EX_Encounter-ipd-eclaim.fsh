Instance: encounter-ipd-eclaim
InstanceOf: $SD_Encounter_Ipd
Title: "ตัวอย่าง Encounter: e-Claim IPD"
Description: "การรับบริการ IPD โดยใช้ข้อมูลจากชุดข้อมูล e-Claim"
Usage: #example
* meta.source = "eclaim"
* extension[0]
...
* diagnosis
  * condition = Reference(Condition/condition-ipd-eclaim)
